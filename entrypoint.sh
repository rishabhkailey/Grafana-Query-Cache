...
function init_variables() {
    ...
    export ACCEPTABLE_TIME_DELTA_SECONDS=${ACCEPTABLE_TIME_DELTA_SECONDS:-"1799"}
    export ACCEPTABLE_TIME_RANGE_DELTA_SECONDS=${ACCEPTABLE_TIME_RANGE_DELTA_SECONDS:-"599"}
    export ACCEPTABLE_MAX_POINTS_DELTA=${ACCEPTABLE_MAX_POINTS_DELTA:-"259"}

    export ENV_VARIABLES_LIST='$GRAFANA_HOST, $GRAFANA_SCHEME, $MAX_CACHE_SIZE, $KEY_ZONE_SIZE, $MAX_INACTIVE_TIME, $CACHE_EXPIRE_TIME, $CACHE_DIRECTORY, $CACHE_VERSION, $SERVER_NAME, $LISTEN, $SSL, $SSL_CERTIFICATE, $SSL_CERTIFICATE_KEY, $SSL_PROTOCOLS, $SSL_CIPHERS, $SSL_CONFIG, $CLIENT_MAX_BODY_SIZE, $DEBUG_IP_CADR, $MIN_REQUEST_COUNT, $ACCEPTABLE_TIME_DELTA_SECONDS, $ACCEPTABLE_TIME_RANGE_DELTA_SECONDS, $ACCEPTABLE_MAX_POINTS_DELTA'
